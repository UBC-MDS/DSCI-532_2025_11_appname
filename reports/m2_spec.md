...
| 4 | As an researcher, I want to be able to reset my search filters to quickly view other features. | ✅ Implemented | *Optional Complexity* Created a reset button to clear filters |
